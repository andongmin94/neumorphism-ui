...
export const componentDocs = [
  {
    ...
    description:
      "Radix Accordion의 키보드 동작과 상태 관리를 유지하면서 열린 항목을 inset 표면으로 표현합니다. single과 multiple 모드, controlled와 uncontrolled 사용을 모두 지원합니다.",
    importCode: `import {
  Accordion,
  AccordionContent,
  AccordionItem,
  AccordionTrigger,
    ...
    usageCode: `<Accordion type="single" collapsible defaultValue="shipping">
  ...
  <AccordionItem value="returns">
    ...
    props: [
      {
        ...
        required: true,
        description: "한 번에 펼칠 수 있는 항목 수를 결정합니다.",
      },
      {
        component: "Accordion",
      ...
      },
      {
        ...
        type: "boolean",
        defaultValue: "false",
        description: "single 모드에서 열린 항목을 다시 닫을 수 있게 합니다.",
      },
      {
        component: "Accordion",
        name: "onValueChange",
    ...
    accessibility: [
      "Radix가 trigger와 panel의 aria-expanded, aria-controls 연결을 관리합니다.",
      "Arrow 키와 Home, End로 trigger 사이를 이동할 수 있습니다.",
  ...
  },
  {
    ...
    description:
      "Radix Avatar 기반으로 이미지 로딩과 fallback 전환을 처리합니다. 세 가지 크기, 상태 badge, 겹쳐진 group과 잔여 인원 count를 제공합니다.",
    importCode: `import {
  Avatar,
  AvatarBadge,
  AvatarFallback,
...
import { Label } from "@/components/ui/label"`,
  ...
  },
  {
    ...
    description:
      "Radix Dialog 기반으로 Portal, Overlay, Content, 제목, 설명, 닫기 동작을 조합합니다. Escape, 외부 클릭, focus trap과 복귀 동작을 primitive가 처리합니다.",
    importCode: `import { Button } from "@/components/ui/button"
import {
  Dialog,
  DialogClose,
  ...
  <DialogContent>
    ...
    props: [
      ...
      },
      {
        ...
        type: "boolean",
        defaultValue: "false",
        description: "자식 요소에 trigger 또는 close 동작을 합성합니다.",
      },
      {
      ...
      },
      {
        ...
        type: "(event) => void",
        description: "기본 닫기 동작을 관찰하거나 preventDefault로 막습니다.",
      },
    ],
    accessibility: [
      "DialogContent 안에 DialogTitle을 제공하고 보조 설명은 DialogDescription으로 연결합니다.",
      "Radix가 모달 포커스 트랩, Escape 닫기, 닫힌 뒤 trigger로의 포커스 복귀를 관리합니다.",
  ...
  },
  {
    ...
    description:
      "Radix Dropdown Menu 기반의 완전한 조합 API입니다. 일반 item, checkbox, radio group, label, separator, shortcut, 중첩 submenu를 한 표면 안에서 구성할 수 있습니다.",
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="soft">메뉴 열기</Button>
      </DropdownMenuTrigger>
    ...
    props: [
      ...
      },
      {
        ...
        type: "boolean",
        defaultValue: "false",
        description: "자식 버튼이나 링크에 trigger 동작을 합성합니다.",
      },
      {
    ...
    accessibility: [
      "Radix가 Arrow 키 탐색, Home, End, typeahead, Escape 닫기와 포커스 복귀를 처리합니다.",
...
import { Label } from "@/components/ui/label"`,
  ...
  },
  {
    ...
    description:
      "Radix Progress의 progressbar 시맨틱을 사용합니다. 유효한 max와 value를 정규화하며 value가 없거나 유효하지 않으면 indeterminate 상태로 전달합니다.",
...
import { Label } from "@/components/ui/label"`,
  ...
  },
  {
    ...
    description:
      "Radix Slider 기반으로 shadcn의 number[] value API를 제공합니다. 배열 항목 수만큼 thumb를 만들고 horizontal과 vertical 방향, controlled와 uncontrolled 값을 지원합니다.",
...
import { Label } from "@/components/ui/label"`,
  ...
  />
    ...
    accessibility: [
      "Slider root에 aria-label 또는 aria-labelledby로 조정 대상의 이름을 제공합니다.",
      "Radix가 각 thumb의 role=slider, 현재 값, 최소·최대 값과 Arrow/Page/Home/End 키 동작을 관리합니다.",
      "여러 thumb를 사용할 때 각 thumb를 구분할 수 있도록 aria-label 배열 또는 적절한 레이블 전략을 적용합니다.",
    ],
  },
  {
    slug: "switch",
...
import { Label } from "@/components/ui/label"`,
  ...
  },
  {
    ...
    description:
      "Radix Tabs 기반으로 active trigger를 raised 표면으로, list를 inset track으로 표현합니다. controlled와 uncontrolled 값, 자동·수동 활성화, 가로·세로 방향을 지원합니다.",
    importCode: `import {
  Tabs,
  TabsContent,
  TabsList,
  ...
  <TabsContent value="access">Focus와 대비 토큰입니다.</TabsContent>
    ...
    props: [
      ...
      },
      {
        ...
        description: "focus 이동만으로 panel을 열지 여부를 결정합니다.",
      },
      {
    ...
    accessibility: [
      ...
      "Radix가 tab, tablist, tabpanel 역할과 aria-controls, aria-selected 연결을 관리합니다.",
      "자동 활성화는 panel 전환이 즉시 가능할 때 사용하고, 비싼 비동기 작업에는 activationMode=manual을 고려합니다.",
    ],
  },
  {
    slug: "textarea",
...
import { Textarea } from "@/components/ui/textarea"`,
  ...
  },
  {
    ...
    description:
      "Radix Tooltip 기반으로 Provider, Root, Trigger, Portal Content를 조합합니다. 기본 provider 지연은 250ms이며 popup은 trigger 주변 충돌을 자동으로 피합니다.",
    importCode: `import { Button } from "@/components/ui/button"
import {
  Tooltip,
  TooltipContent,
  ...
  <Tooltip>
    <TooltipTrigger asChild>
      <Button size="icon" aria-label="설정 열기">⚙</Button>
    </TooltipTrigger>
    ...
    props: [
      ...
      },
      {
        ...
        type: "boolean",
        defaultValue: "false",
        description: "자식 요소에 tooltip trigger 동작을 합성합니다.",
      },
      {
    ...
    accessibility: [
      ...
      "Radix가 hover뿐 아니라 keyboard focus에서 열고 Escape로 닫는 동작을 제공합니다.",
    ],
  },
