...
export const showcaseMessages = {
  ko: {
    ...
    feedback: {
      ...
      registryDescription: "56개 컴포넌트 중 필요한 항목만 설치할 수 있습니다.",
      themeSetup: "테마 설정",
  ...
  en: {
    ...
    feedback: {
      ...
      registryDescription:
        "Install only the components you need from the set of 56.",
  ...
  zh: {
    ...
    feedback: {
      ...
      registryDescription: "可从 56 个组件中按需选择安装。",
      themeSetup: "主题设置",
  ...
  ja: {
    ...
    feedback: {
      ...
      registryDescription:
        "56個のコンポーネントから必要なものだけを選んでインストールできます。",
      themeSetup: "テーマ設定",
