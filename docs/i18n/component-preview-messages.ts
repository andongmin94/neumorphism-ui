...
const ko = {
  ...
  alert: {
    ...
    synced: "동기화 완료",
    syncedBody: "56개 컴포넌트가 현재 프로젝트와 일치합니다.",
...
const en: ComponentPreviewMessages = {
  ...
  alert: {
    ...
    syncedBody: "All 56 components match the current project.",
...
const ja: ComponentPreviewMessages = {
  ...
  alert: {
    ...
    synced: "同期が完了しました",
    syncedBody: "56 個のコンポーネントが現在のプロジェクトと一致しています。",
