...
- Work on `main` only. Do not create work branches or pull-request branches.
- Body and UI typography use Pretendard. Code, preformatted text and keyboard labels use Consolas first, with only the generic monospace fallback.
- Keep registry source, generated endpoints and documentation synchronized. Never hand-edit generated JSON, CSS or bootstrap files.
