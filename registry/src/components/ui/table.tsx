...
function Table({ className, ...props }: React.ComponentProps<"table">) {
  return (
    <div
      ...
      className="relative w-full overflow-x-auto rounded-[var(--neu-radius-surface)] border border-[color:var(--neu-edge)] bg-[var(--neu-surface)] [box-shadow:var(--neu-shadow-raised-sm)]"
    >
      <table
        data-slot="table"
...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "border-b border-[var(--border)] transition-[background-color,box-shadow] duration-[var(--neu-duration)] hover:bg-[var(--neu-surface-soft)] data-[state=selected]:bg-[var(--neu-surface-low)] data-[state=selected]:[box-shadow:var(--neu-shadow-inset)]",
        className,
      )}
      {...props}
    />
