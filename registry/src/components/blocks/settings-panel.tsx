    ...
    <div className="grid min-w-0 gap-8 lg:grid-cols-[15rem_minmax(0,1fr)]">
      ...
      <Form key={revision} onSubmit={submit} aria-busy={pending} className="gap-7">
        <fieldset disabled={pending} className="m-0 grid min-w-0 gap-7 border-0 p-0">
          <section id={`${id}-profile`} className="grid scroll-mt-24 gap-5 rounded-[var(--neu-radius-surface)] border border-[color:var(--neu-edge)] bg-[var(--neu-surface)] p-5 [box-shadow:var(--neu-shadow-raised-sm)] sm:p-7"><h3 className="text-lg font-semibold">{t.profile}</h3>
          ...
          <section id={`${id}-notifications`} className="grid scroll-mt-24 gap-5 rounded-[var(--neu-radius-surface)] border border-[var(--border)] bg-[var(--neu-surface)] p-5 sm:p-7"><h3 className="text-lg font-semibold">{t.preference}</h3>
